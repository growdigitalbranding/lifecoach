    ...
    >
      <Link href={`/blog/${post.slug}`} className="grid gap-6 py-8 md:grid-cols-12 md:gap-10">
        <div className="md:col-span-4 lg:col-span-3">
          <div className="cover-grain relative aspect-[4/3] overflow-hidden md:aspect-[3/2]">
        ...
        <div className="md:col-span-8 lg:col-span-9">
          <div className="flex items-center gap-4 text-[11px] uppercase tracking-[0.2em] text-[var(--muted)]">
          ...
          <h2 className="display mt-4 text-[clamp(1.75rem,3.6vw,2.75rem)] transition-colors group-hover:text-[var(--forest)]">
            {post.title}
          </h2>
